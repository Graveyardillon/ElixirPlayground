defmodule Mac.Formatter do
  ...
  @formatter_exceptions [Mac.AssertionError, FunctionClauseError]
  @no_value Mac.AssertionError.no_value()
  ...
  def format_test_failure(test, failures, counter, width, formatter) do
    %Mac.Test{name: name, module: module, tags: tags} = test
  ...
  @doc false
  def format_assertion_error(%Mac.AssertionError{} = struct) do
    format_exception(%{}, struct, [], :infinity, fn _, msg -> msg end, "") |> elem(0)
  end

  defp format_exception(test, %Mac.AssertionError{} = struct, stack, width, formatter, pad) do
  ...
  @doc false
  @deprecated "Use Mac.Formatter.format_test_all_failure/5 instead"
